...
<div class="wrap">
			...
			<div class="rr_admin_sidebar">
				...
				<ul class="rr_admin_sidebar_list">
                    ...
                    <li class="rr_admin_sidebar_list_item">
                        [RICH_REVIEWS_SNIPPET hide_no_reviews="yes"] (default is "no")
                    </li>
				</ul>
			</div>
            <div class="rr-logo"><img src="<?php echo esc_url($this->parent->logo_small_url); ?>"></div>
			<p><?php echo __('Thank you for using Rich Reviews by', 'rich-reviews'); ?> <a href="https://starfish.reviews">Starfish</a>!</p>
			<p>
            ...
            <p style="margin-top:30px;">
			 <h3><?php echo __('Some terminology so that we are all on the same page:', 'rich-reviews');?></h3>
				<ul>
					<li>
                        <?php echo __('A <b>global review</b> is a review which applies or belongs to the entire Wordpress site, regardless of the current page or post. You might use global reviews if your users are submitting reviews for a business or entire website.', 'rich-reviews'); ?>
					</li>
					<li>
                        <?php echo __('A <b>per-page review</b> is a review which applies to some specific page or post. You might use per-page reviews if, for example, your Wordpress site has various products with a dedicated page or post for each one. Note that reviews users submit will <i>always</i> record the post from which they were submitted, even if you will end up using global reviews! This is to simplify things, so that we don\'t have a bunch of different, confusing shortcodes.', 'rich-reviews'); ?>
					</li>
				</ul>
			</p>
			<div class="clear"></div>