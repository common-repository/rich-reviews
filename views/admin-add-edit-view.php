...
class RRAdminAddEdit {
	...
	function __construct($core) {
		$this->core = $core;
		if (isset($_GET['rr_id'])) {
			$this->rr_id = esc_html($_GET['rr_id']);
		}
	...
	function check_add_update() {
		...
		$form_text = '';
		$form_email = '';
		if (isset($_POST['_wpnonce']) && check_admin_referer( 'rr_admin_save_review_' . $_POST['review_parent'] )) {
            ...
            $validData = true;
            if($this->core->rr_form_options['form-name-display']) {
            ...
            if($this->core->rr_form_options['form-title-display']) {
            ...
            if($this->core->rr_form_options['form-content-display']) {
            ...
            if($this->core->rr_form_options['form-email-display']) {
            ...
            if ($validData) {
                ...
                $output .= '<span class="rr-message">The review has been saved.</span><br />';
...
<form method="post" action="">
    <?php wp_nonce_field( 'rr_admin_save_review_' . $review['post_id'] ); ?>
	<table class="form_table">
		...
		<tr class="rr_form_row">
			<td class="rr_form_heading <?php if($this->core->rr_form_options['form-name-require']) { echo 'rr_required'; } ?>"><?php echo $this->core->rr_form_options['form-name-label']; ?></td>
		...
		<tr class="rr_form_row">
			<td class="rr_form_heading <?php if($this->core->rr_form_options['form-email-require']) { echo 'rr_required'; } ?>"><?php echo $this->core->rr_form_options['form-email-label']; ?></td>
		...
		<tr class="rr_form_row">
			<td class="rr_form_heading <?php if($this->core->rr_form_options['form-title-require']) { echo 'rr_required'; } ?>"><?php echo $this->core->rr_form_options['form-title-label']; ?></td>
		...
		<tr class="rr_form_row">
			<td class="rr_form_heading <?php if($this->core->rr_form_options['form-content-require']) { echo 'rr_required'; } ?>"><?php echo $this->core->rr_form_options['form-content-label']; ?></td>
